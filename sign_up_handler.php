...
<?php
	...
	if($correct) {
		...
		$db_id = mysqli_query($db_connect, "SELECT id FROM users WHERE (login='".@$_SESSION['login']."' or email='".@$_SESSION['login']."') and password='".@$_SESSION['password']."'");
